            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h2 class="text-sm ml-2 mb-1 p-0 text-gray-500 font-semibold"><i class="fas fa-info-circle"></i> En la columna de proveedor, debe colocar el nombre del proveedor pero que sea exactamente igual al nombre registrado en la bdd, ejemplo v&j c.a</h2>
