...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::dtJOdHMhnlmP0X3C',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::J8sZchKjgSMI3VPG',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::6FBTgfGDvxkruUSp',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::LpMD3ptZMVeX3YMe',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::epT6G3HTi1Vmsoxr',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::I5eLwCI6DQs7wgkH',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::3t1dHq2avo1o8kv7',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::w4QlFr4h1RB0i4ik',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/livewire/(?|message/([^/]++)(*:36)|preview\\-file/([^/]++)(*:65))|/p(?|assword/reset/([^/]++)(*:100)|roductos(?|/([^/]++)/(?|edit(*:136)|files(*:149))|_serial/([^/]++)(*:174)))|/r(?|oles/([^/]++)(?|/edit(*:210)|(*:218))|eportes_(?|productos/([^/]++)/([^/]++)/([^/]++)(*:274)|ventas/([^/]++)/([^/]++)/([^/]++)(*:315)|traslados/([^/]++)/([^/]++)(*:350)|caja/([^/]++)/([^/]++)/([^/]++)(*:389)|kardex/([^/]++)/([^/]++)(*:421)))|/Ventas/([^/]++)(?|(*:450)|/(?|edit(*:466)|([^/]++)(*:482))|(*:491))|/Mostrar_ventas/([^/]++)(?|(*:527)|/(?|edit(*:543)|([^/]++)(*:559))|(*:568))|/facturacion/([^/]++)/([^/]++)(*:607)|/traslado/([^/]++)(?|(*:636)|/([^/]++)(*:653))|/Nuevo_movimiento_(?|caja/([^/]++)(*:696)|pendiente_caja/([^/]++)(*:727))|/historial_modalidad/([^/]++)/([^/]++)/([^/]++)/([^/]++)(*:792)|/ventas_clientes/([^/]++)(*:825))/?$}sDu',
    ),
    3 => 
    array (
      36 => 
  ...
  array (
    ...
    return $request->user();
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"0000000020e84d67000000006b9e1639";}";s:4:"hash";s:44:"IxaYu+jdZZBmg06MMJak7INBxHbpkZRk8Fgv4i+4FnU=";}}',
        'namespace' => NULL,
        'prefix' => 'api',
        'where' => 
        array (
        ),
        'as' => 'generated::LpMD3ptZMVeX3YMe',
      ),
      'fallback' => false,
      'defaults' => 
      array (
...
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"0000000020e84d65000000006b9e1639";}";s:4:"hash";s:44:"CBlh4lvallE0t2A33ucPBT+OLLpb093MdPDNtNluIKk=";}}',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'generated::epT6G3HTi1Vmsoxr',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Productos\\ProductosSerialController@index',
        'controller' => 'App\\Http\\Controllers\\Productos\\ProductosSerialController@index',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'productos.serial.index',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Productos\\ProductosSerialController@store',
        'controller' => 'App\\Http\\Controllers\\Productos\\ProductosSerialController@store',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'productos.serial.store',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Productos\\ProductosSerialController@view',
        'controller' => 'App\\Http\\Controllers\\Productos\\ProductosSerialController@view',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'productos.serial.view',
      ),
      'fallback' => false,
      'defaults' => 
      array (
